...
class VisitorRegistration extends BaseController
{
    ...
    public function submit()
    {
        ...
        try {
            ...
            $visitorData = [
                ...
                'registration_no' => $this->isFormFieldEnabled('company_reg_id', $formConfig) ? ($this->request->getPost('company_reg_id') ?? '') : '',
    ...
    private function getDefaultEmailTemplateFormConfig(): array
    {
        return [
            ...
            'visit_info_section' => true,
            'date_of_visit_section' => true,
            'details_of_visit_section' => true,
            'person_details_section' => true,
